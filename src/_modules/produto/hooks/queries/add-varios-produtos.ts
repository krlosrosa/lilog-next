import { CreateManyProdutosMutationBody, useCreateManyProdutos } from "@/_services/api/service/produto/produto";
...
export function useAddVariosProdutos() {
  ...
  const { mutateAsync: addVariosProdutos, isPending: isAddingVariosProdutos } = useCreateManyProdutos({
