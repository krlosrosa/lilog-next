...
export default function ProdutividadeDiaDia({ produtividadeDiaDia }: GraficoDiaDiaProps) {

const chartConfig = {
  produtividade: {
    label: "Produtividade",
  },
  produtividadeCaixaPorHora: {
    label: "Produtividade",
    color: "var(--chart-1)",
  },
  ...
  const filteredData = produtividadeDiaDia.filter((item) => {
    const date = new Date(item.data?.toString() || '')
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        ...
        >
          <AreaChart data={filteredData}>
            ...
            />
            <Area
              dataKey="produtividadeCaixaPorHora"
              type="natural"
              fill="url(#fillMobile)"
