...
import { convertFileToClientesSegregados } from '@/_modules/expedicao_/others/utils/xlsx/segregarClientes.convert';

type UploadClientesSegregadosProps = {
  handleSegregedClientes: (clientes: string[]) => void;
}

export function UploadClientesSegregados({ handleSegregedClientes }: UploadClientesSegregadosProps) {
