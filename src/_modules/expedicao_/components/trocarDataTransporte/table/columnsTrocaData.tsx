...
export const columnsTrocaData: ColumnDef<ResultTransporteDtoOutput>[] = [
  {
    id: 'select-col',
    header: ({ table }) => (
      <Checkbox
        checked={
          ...
          // Se algumas estão selecionadas, mas não todas, o valor é 'indeterminate'
          (table.getIsSomeRowsSelected() && 'indeterminate') 
        }
        // Use a função de callback para garantir que o onCheckedChange funcione
