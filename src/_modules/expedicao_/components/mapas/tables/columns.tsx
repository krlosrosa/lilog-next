...
import { ImpressaoMapaItem } from '@/_modules/expedicao_/others/types/items';

export const columnsMapa: ColumnDef<ImpressaoMapaItem>[] = [
  {
  ...
  },
  {
    ...
    header: 'Faixa',
    cell: ({ row }) => {
      return <div className="">{row.original.faixa.toUpperCase() === 'VERDE' ? '' : row.getValue('faixa')}</div>;
    },
  },
];
