...
import type { CreateProdutoDto, UpdateProdutoDto } from '../../model';
...
export type CreateProdutoMutationError = ErrorType<
...
export const getFindAllProdutosQueryOptions = <
  TData = Awaited<ReturnType<typeof findAllProdutos>>,
  TError = ErrorType<void | void | void | void | void | void>,
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof findAllProdutos>>, TError, TData>
  >;
  request?: SecondParameter<typeof axiosFetcher>;
}) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof findAllProdutos>>> = ({
    signal,
  }) => findAllProdutos(requestOptions, signal);
...
export type FindAllProdutosQueryResult = NonNullable<
  Awaited<ReturnType<typeof findAllProdutos>>
>;
export type FindAllProdutosQueryError = ErrorType<
  void | void | void | void | void | void
>;

export function useFindAllProdutos<
  TData = Awaited<ReturnType<typeof findAllProdutos>>,
  TError = ErrorType<void | void | void | void | void | void>,
>(
  options: {
...
export const getCreateManyProdutosMutationOptions = <
  TError = ErrorType<void | void | void | void | void | void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type CreateManyProdutosMutationResult = NonNullable<
  Awaited<ReturnType<typeof createManyProdutos>>
>;
export type CreateManyProdutosMutationBody = BodyType<CreateProdutoDto[]>;
export type CreateManyProdutosMutationError = ErrorType<
  void | void | void | void | void | void
>;
 ...
 * @summary Criar múltiplos produtos
 */
export const useCreateManyProdutos = <
  TError = ErrorType<void | void | void | void | void | void>,
  TContext = unknown,
>(
  options?: {
...
export const getFindProdutoBySkuQueryKey = (sku?: string) => {
  return [`/api/produto/${sku}`] as const;
};

export const getFindProdutoBySkuQueryOptions = <
  TData = Awaited<ReturnType<typeof findProdutoBySku>>,
  TError = ErrorType<void | void | void | void | void | void>,
>(
  sku: string,
  options?: {
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof findProdutoBySku>>
  > = ({ signal }) => findProdutoBySku(sku, requestOptions, signal);
...
export type FindProdutoBySkuQueryResult = NonNullable<
  Awaited<ReturnType<typeof findProdutoBySku>>
>;
export type FindProdutoBySkuQueryError = ErrorType<
  void | void | void | void | void | void
>;

export function useFindProdutoBySku<
  TData = Awaited<ReturnType<typeof findProdutoBySku>>,
  TError = ErrorType<void | void | void | void | void | void>,
>(
  sku: string,
...
export const getUpdateProdutoBySkuMutationOptions = <
  TError = ErrorType<void | void | void | void | void | void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateProdutoBySkuMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateProdutoBySku>>
>;
export type UpdateProdutoBySkuMutationBody = BodyType<UpdateProdutoDto>;
export type UpdateProdutoBySkuMutationError = ErrorType<
  void | void | void | void | void | void
>;
 ...
 * @summary Atualizar um produto pelo SKU
 */
export const useUpdateProdutoBySku = <
  TError = ErrorType<void | void | void | void | void | void>,
  TContext = unknown,
>(
  options?: {
...
export const getDeleteProdutoBySkuMutationOptions = <
  TError = ErrorType<void | void | void | void | void | void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteProdutoBySkuMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteProdutoBySku>>
>;

export type DeleteProdutoBySkuMutationError = ErrorType<
  void | void | void | void | void | void
>;
 ...
 * @summary Deletar um produto pelo SKU
 */
export const useDeleteProdutoBySku = <
  TError = ErrorType<void | void | void | void | void | void>,
  TContext = unknown,
>(
  options?: {
